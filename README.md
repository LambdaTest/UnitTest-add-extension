# Add Browser Extensions in Python UnitTest with Selenium on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can upload and load browser extensions into your automated test sessions to test webapps that require specific extensions. This sample shows how to configure browser extensions in Python UnitTest on the TestMu AI cloud.
...
Note: You will need the Chrome Extension's ID for this. I am referring it to as $ID$. You can get the $ID$ from the URL of the Chrome Extension page.
...
1. [Use the TestMu AI (Formerly LambdaTest) extension upload API to upload the zip file to the backend.](https://www.testmuai.com/support/api-doc/#/extensions/UploadExtensions)
